const u = {
  ...
  const l = r[o], s = y(a), i = n(s, ["duo-icon", `duo-icon-${e}`]);
  s.class = n(i, t.hasOwnProperty("class") ? t.class : []);
  const p = Object.assign(t, s), d = h(p, l);
  return (c = a.parentNode) == null ? void 0 : c.replaceChild(d, a);
